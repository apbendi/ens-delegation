...
export class ENS__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class ENS extends ethereum.SmartContract {
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): ENS__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<ENS__checkpointsResultValue0Struct>(result[0].toTuple());
  }

  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<ENS__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<ENS__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
